        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Find restaurants, specials</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class=" theme-btn btn-lg btn btn-success">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
