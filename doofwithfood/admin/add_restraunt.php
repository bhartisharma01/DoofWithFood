            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card-header">
                                <div class="card-title">Add Restaurant</div>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                        ...
                                        <div class="row ">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" placeholder="Mobile No."  onkeypress="return onlyNumberKey(event)" maxlength="10">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="url" class="form-control form-control-danger" placeholder="Website URL">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_hr" class="form-control custom-select" data-placeholder="Choose a Category" >
                                                     <option>Select your Open Hours</option>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_hr" class="form-control custom-select" data-placeholder="Choose a Category" >
                                                     <option>Select your Close Hours</option>
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>Select your Open Days</option>
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" name="submit" class="btn btn-success" value="Add Restaurant"> 
